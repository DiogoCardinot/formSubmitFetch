...
const addLoad = ()=>{
    document.querySelector("button").innerHTML = `<img src="./loading.png" alt="loadingImage" class="loadingImage">
`}
...
const sendEmail = (event) =>{
    ...
    if(nome.value != "" && tel.value != "" && (email.value != "" && emailTest.test(email.value)) && assunto.value != "" && mensagem.value!= ""){
        addLoad();
        console.log("AAA")
